...
import { faAngleDoubleRight, faBookOpen, faEnvelope, faHeart, faImages, faPaperPlane, faPaw } from '@fortawesome/free-solid-svg-icons'
  ...
  return (
    ...
    <div className="flex flex-wrap -mx-4 -mb-10">
      <div className="sm:w-full mb-10 px-4 .text-left">
        <h1 className="title-font text-2xl font-medium text-gray-900 mt-6 mb-3">
          <FontAwesomeIcon icon={faAngleDoubleRight} className="mr-2"/>ランディングページタイトル</h1>
      ...
      <div className="sm:w-1/2 mb-10 px-4 .text-left">
        ...
        <p className="w-2/3 leading-relaxed text-base">画像ビューアのサンプルに飛びます。</p>
        <div className="mt-5">
          </div>
      </div>
      ...
      <div className="sm:w-1/5 flex flex-col mb-10 px-4 .text-left">
        <div className="mt-8">
          <p className="leading-relaxed text-base mr-2　mb-3"><FontAwesomeIcon icon={faEnvelope} className="mr-2"/>フォーム</p>
        </div>
        <div className="mt-5">
          <Link href={{
            pathname: '/users/[uid]',
      ...
      <div className="sm:w-1/5 flex flex-col mb-10 px-4 .text-left">
        <div className="mt-8">
          <p className="leading-relaxed text-base mr-2　mb-3"><FontAwesomeIcon icon={faPaw} className="mr-2"/>ブログ</p>
        </div>
        <div className="mt-5">
          <Link href={{
            pathname: '/blog',
